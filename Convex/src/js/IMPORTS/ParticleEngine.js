...
function ParticleEngine()
{
    ...
    this.particleGeometry.addAttribute('position', new THREE.BufferAttribute(new Float32Array(this.particleCount*3),3));
    this.particleGeometry.addAttribute('customVisible', new THREE.BufferAttribute(new Float32Array(this.particleCount),1));
    this.particleGeometry.addAttribute('customAngle', new THREE.BufferAttribute(new Float32Array(this.particleCount),1));
    this.particleGeometry.addAttribute('customSize', new THREE.BufferAttribute(new Float32Array(this.particleCount),1));
    this.particleGeometry.addAttribute('customColor', new THREE.BufferAttribute(new Float32Array(this.particleCount*3),3));
    this.particleGeometry.addAttribute('customOpacity', new THREE.BufferAttribute(new Float32Array(this.particleCount),1));
...
ParticleEngine.prototype.initialize = function()
{
    ...
    for (var i = 0; i < this.particleCount; i++)
    {
        ...
        this.particleGeometry.attributes.position.array[3*i] = this.particleArray[i].position.x;
        this.particleGeometry.attributes.position.array[3*i+1] = this.particleArray[i].position.y;
        this.particleGeometry.attributes.position.array[3*i+2] = this.particleArray[i].position.z;
        this.particleGeometry.attributes.customColor.array[3*i] = this.particleArray[i].color.r;
        this.particleGeometry.attributes.customColor.array[3*i+1] = this.particleArray[i].color.g;
        this.particleGeometry.attributes.customColor.array[3*i+2] = this.particleArray[i].color.b;
    ...
    console.log(this.particleGeometry.attributes, this.particleGeometry)
...
ParticleEngine.prototype.update = function(dt)
{
    ...
    this.particleGeometry.computeBoundingSphere();
    // console.log(this.particleGeometry.attributes.position)
    ...
    for (var j = 0; j < recycleIndices.length; j++)
    {
        ...
        this.particleGeometry.attributes.customOpacity.array[i] = this.particleArray[i].alive;
        this.particleGeometry.attributes.position.array[3*i] = this.particleArray[i].position.x;
        this.particleGeometry.attributes.position.array[3*i+1] = this.particleArray[i].position.y;
        this.particleGeometry.attributes.position.array[3*i+2] = this.particleArray[i].position.z;
    }
