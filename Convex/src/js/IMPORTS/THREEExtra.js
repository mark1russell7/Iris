THREE.ParametricGeometries = {
    ...
    mobius3d: function (major=2.25, a=0.125, b=0.65) {
        return function(u, t, vec) {
...
THREE.ParametricGeometries.TubeGeometry = function(path, segments, radius, segmentsRadius, closed, debug) {
    ...
    var ParametricTube = function(u, v, vec) {
        v *= 2 * Math.PI;
...
THREE.ParametricGeometries.TorusKnotGeometry = function ( radius, tube, segmentsR, segmentsT, p, q, heightScale ) {
    ...
    THREE.ParametricGeometries.TubeGeometry( this, extrudePath, segments, tube, radiusSegments, true, false );
...
THREE.ParametricGeometries.SphereGeometry = function(size, u, v) {
    ...
    return function sphere(u, v, vec) {
        u *= Math.PI;
        v *= 2 * Math.PI;
