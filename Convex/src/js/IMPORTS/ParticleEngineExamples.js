        ...
        fountain :
            {
                ...
                particleTexture : new THREE.TextureLoader().load( root + 'star.png' ),
        ...
        fireball :
            {
                ...
                particleTexture : new THREE.TextureLoader().load( root + 'smokeparticle.png' ),
        ...
        snow :
            {
                ...
                particleTexture : new THREE.TextureLoader().load( root + 'snowflake.png' ),
        ...
        rain :
            {
                ...
                particleTexture : new THREE.TextureLoader().load( root + 'raindrop2flip.png' ),
        ...
        starfield :
            {
                ...
                particleTexture : new THREE.TextureLoader().load( root + 'spikey.png' ),
        ...
        fireflies :
            {
                ...
                particleTexture : new THREE.TextureLoader().load( root + 'spark.png' ),
