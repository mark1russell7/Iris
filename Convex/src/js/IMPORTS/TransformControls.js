...
THREE.TransformControls = function ( camera, domElement ) {
...

    {
        ...
        domElement.addEventListener( "mousedown", onPointerDown, {passive : true} );
        domElement.addEventListener( "touchstart", onPointerDown, {passive : true} );
        domElement.addEventListener( "mousemove", onPointerHover, {passive : true} );
        ...
        domElement.addEventListener( "touchcancel", onPointerUp, {passive : true} );
        domElement.addEventListener( "touchleave", onPointerUp, {passive : true} );
        domElement.addEventListener( "contextmenu", onContext, {passive : true} );

    }

    this.dispose = function () {

        domElement.removeEventListener( "mousedown", onPointerDown ,{passive : true});
        domElement.removeEventListener( "touchstart", onPointerDown ,{passive : true});
        domElement.removeEventListener( "mousemove", onPointerHover ,{passive : true});
        domElement.removeEventListener( "touchmove", onPointerHover ,{passive : true});
        domElement.removeEventListener( "touchmove", onPointerMove ,{passive : true});
        document.removeEventListener( "mouseup", onPointerUp ,{passive : true});
        domElement.removeEventListener( "touchend", onPointerUp ,{passive : true});
        domElement.removeEventListener( "touchcancel", onPointerUp ,{passive : true});
        domElement.removeEventListener( "touchleave", onPointerUp ,{passive : true});
        domElement.removeEventListener( "contextmenu", onContext ,{passive : true});
